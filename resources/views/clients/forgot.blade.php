...
@section('css')
    <style>
        #forgot {
            background-image: url('http://127.0.0.1:8000/bookingHotel/public/images/banner%203.jpg');
        }
    </style>
@endsection
@section('content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('login') }}" class="btn" style="background-color: #86B817;color:white;">Đăng
                        nhập</a>
                </div>
            </div>
        </div>
