        ...
        @foreach ($topBookings as $keyBooking => $valueBooking)
            <div class="col-lg-3 col-md-3 col-md-4 col-sm-6 col-12 my-2" style="padding: 20px;background-color: #ffffff;">
                <div class="card">
                    ...
                    <div class="card-name">
                        <a href="{{ route('hotel-detail', ['id' => $valueBooking->id]) }}" style="text-decoration: none;color:black;">
                            <h6 class="card-title my-2">{{ $valueBooking->name_hotel }}</h6>
                        </a>
        ...
        @foreach ($topViewHotel as $keyViewHotel => $valueViewHotel)
            <div class="col-lg-3 col-md-3 col-md-4 col-sm-6 col-12 my-2" style="padding: 20px;background-color: #ffffff;">
                <div class="card">
                    ...
                    <div class="card-name">
                        <a href="{{ route('hotel-detail', ['id' => $valueViewHotel->id]) }}" style="text-decoration: none;color:black;">
                            <h6 class="card-title my-2">{{ $valueViewHotel->name_hotel }}</h6>
                        </a>
                        <!-- <span style="font-size: 13px;">Có công viên nước, từ 1.980k/đêm</span> -->
                    </div>
                </div>
